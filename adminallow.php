                ...
                <div id="header">
                    <div id="menu">
                        <ul>
                            ...
                            <li><a href="adminallow.php" class="active">Allow Product</a></li>
...
$result = mysql_query("SELECT * FROM allow_product");
...
while($row = mysql_fetch_array($result))
{
	...
	echo "<td><u><a href='allow.php?cid=$row[company_id]&a=$row[Product_name]&b=$row[Product_description]&abc=$row[Product_img]&prs=$row[Product_cost]&unit=$row[Product_units]'><input type=button value=ALLOW></a></u></td>";
	echo "</tr>";
}
echo "</table>";
